...
def generate_launch_description():
    ...
    urdf2tf = launch.actions.IncludeLaunchDescription(PythonLaunchDescriptionSource(
    ...
    ydlidar = launch.actions.IncludeLaunchDescription(PythonLaunchDescriptionSource(
        [ydlidar_ros2_dir, '/launch', '/ydlidar_launch.py']
    ),)

    # 使用TimerAction启动后5s执行ydlidar节点
